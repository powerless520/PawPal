...
export const I18N = {
  "zh-CN": {
    ...
    settings: {
      ...
      diaryPlay: "朗读",
      diaryCoverTitle: (name: string) => `${name} 的日记本`,
      diaryCoverCount: (n: number) => `已写下 ${n} 篇小日记`,
      diaryBackCover: "未完待续…",
      diaryBackHint: "今天先记到这里，明天见~",
      diaryPrev: "上一页",
      diaryNext: "下一页",
      diaryTurnHint: "点击箭头或用 ← → 翻页，点小圆点可以直达",
      playCatch: "扔球给我",
      chatWithPet: "和宠物聊天",
      petActions: "宠物表情",
      petActionDance: "跳支舞",
  ...
  en: {
    ...
    settings: {
      ...
      diaryPlay: "Read aloud",
      diaryCoverTitle: (name: string) => `${name}'s diary`,
      diaryCoverCount: (n: number) => (n === 1 ? "1 little entry inside" : `${n} little entries inside`),
      diaryBackCover: "To be continued…",
      diaryBackHint: "That's all for now — see you tomorrow~",
      diaryPrev: "Previous page",
      diaryNext: "Next page",
      diaryTurnHint: "Flip with the arrows or ← → keys; tap a dot to jump",
